...
| P2-03 | Implement Entity Scene Graph, local/world Transform, hierarchy, and dirty flow    | P2-01                   | Parent/reparent/remove tests; deep dirty propagation; cycle and nonfinite guards  | In Development |
