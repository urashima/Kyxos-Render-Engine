...
| P2-07 | Add the independent `/acceptance/phase-02` Playground route                       | P2-06                   | Primitive, hierarchy, orbit/framing, culling, ordering, and diagnostic flows      | In Development |
