...
| P0-04 | Core lifecycle, typed events, stable errors, handles, and disposal contracts                                                  | P0-03      | Unit tests for lifecycle, error shape, event unsubscribe, and idempotent dispose | In Development |
