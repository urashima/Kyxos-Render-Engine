...
| P0-03 | Package manifests and public export boundaries for core, backend-api, renderer, frame-scheduler, sdk, and testing             | P0-02      | Every package builds independently; exports expose no private paths              | In Development |
