...
| P0-05 | Backend capability contract and mock backend with resource accounting                                                         | P0-04      | Unit and integration tests; dispose returns counters to baseline                 | In Development |
