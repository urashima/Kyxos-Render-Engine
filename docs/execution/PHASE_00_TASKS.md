...
| P0-06 | Renderer shell, scheduler baseline, registration APIs, and public SDK factory                                                 | P0-05      | SDK-only consumer test; mock renderer create/invalidate/dispose                  | In Development |
