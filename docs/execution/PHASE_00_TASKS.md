...
| P0-07 | Framework-independent Vite Playground and `/acceptance/phase-00` route                                                        | P0-06      | Browser smoke test; no Texture Lab dependency                                    | Development Complete |
| P0-08 | Vitest, Playwright, shader validation placeholder with honest capability status, bundle budget, and dependency boundary gates | P0-07      | Full local gate; deliberate forbidden import fixture fails                       | In Development       |
