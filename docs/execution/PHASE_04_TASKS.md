...
| P4-12 | Expose public Temporal PBR Canvas lifecycle and independent Phase 4 acceptance Playground                   | P4-11             | SDK-only route, loss/recovery, reviewed zero-diff visual, evidence, Phase 4 checker and CI          | In Development |
