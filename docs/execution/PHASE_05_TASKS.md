...
Pull request: `#12`  
Base: Phase 4 Final merge `f926f544c94da2c5ea8f9630c959398b15d2d84f`
...
- Draft PR #12 must be synchronized with current `main` before further P5-02 implementation or verification.
